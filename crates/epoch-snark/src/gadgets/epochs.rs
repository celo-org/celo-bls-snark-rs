...
use algebra::{bls12_377::Bls12_377, cp6_782::Fr};
...
pub struct ValidatorSetUpdate<E: PairingEngine> {
    ...
    /// constrain the inner CRH->XOF hashes in CP6_782 and instead it will be verified
    ...
    > {
        ...
        for (i, epoch) in self.epochs.iter().enumerate() {
            ...
            let constrained_epoch = epoch.constrain(
                ...
                self.num_validators,
                self.hash_helper.is_none(), // generate constraints in CP6_782 if no helper was provided
            )?;
