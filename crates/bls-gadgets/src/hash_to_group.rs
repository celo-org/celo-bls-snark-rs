...
impl HashToGroupGadget<Bls12_377_Parameters> {
    ...
    fn pedersen_hash<CS: ConstraintSystem<Bls12_377_Fq>>(
        ...
        let crh_params = <BHHashSW6 as FixedLengthCRHGadget<CRH, _>>::ParametersGadget::alloc_constant(
...
impl<P: Bls12Parameters> HashToGroupGadget<P> {
        ...
        G1Projective<P>: Borrow<GroupProjective<P::G1Parameters>>,
    {
        ...
        let generator = G1Gadget::<P>::alloc_constant(cs.ns(|| "generator"), G1Projective::<P>::prime_subgroup_generator())?;
        let scaled = p
